...
namespace Pocketses.Core.Extensions
{
	public static class MapperExtensions
	{
		...
		public static IMappingExpression<TSource, TDest> MapFrom<TSource, TDest, TProperty>(this IMappingExpression<TSource, TDest> map, Expression<Func<TDest, TProperty>> destinationMember, Expression<Func<TSource, TProperty>> sourceMember)
		{
			return map.ForMember(destinationMember, options => options.MapFrom(sourceMember));
		}
	}
}