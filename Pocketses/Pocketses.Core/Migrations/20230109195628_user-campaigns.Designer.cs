...
namespace Pocketses.Core.Migrations
{
    ...
    [Migration("20230109195628_user-campaigns")]
    partial class usercampaigns
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CampaignUser", b =>
                {
                    ...
                    b.Property<Guid>("UserCampaignsId")
                        .HasColumnType("TEXT");

                    b.HasKey("PlayersId", "UserCampaignsId");

                    b.HasIndex("UserCampaignsId");
            ...
            modelBuilder.Entity("CampaignUser", b =>
                {
                    b.HasOne("Pocketses.Core.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pocketses.Core.Models.Character", b =>
                {
                    ...
                    b.HasOne("Pocketses.Core.Models.User", "User")
                        .WithMany("Characters")
                        .HasForeignKey("UserId");
